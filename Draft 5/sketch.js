...
function setup() {
  ...
  colorMode(HSL);
  testseed = parseInt(`${month()}${day()}${year()}${hour()}`);
  ...
  title = "In this story, today is " + illusMonth + "." + illusDay + "." + illusYear + " \n at " + illusHour%12 + ":" + minute() + " " + ampm;;
  textAlign(CENTER);
  text(title, 200, 50);
  //bgTex.color = [360, 58, 60, seed];
}
...
function draw() {
  ...
  bgCloud.drawcloud(400, 400);
  bgCloud2.drawcloud(400, 390);

  //under
  
  drawSun(illusHour, random(20,200), random(0, 360), random(70, 99), 50, seed);
  push();
  noStroke();
  fill(360, 5, 80);
  rect(0, 400, 400, 200);
